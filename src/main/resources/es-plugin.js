...
(function() {
  ...
  })("/rest/eslink/1.0/connections", ['ID', 'name', 'description', 'url', 'apiKey', 'pollingInterval', 'isEnabled']);
  ...
  (function(baseUrl) {
    var createListener, editLink, initPage, initUserInput, linkParams, manualImport, mergeFormData, paramNames, projectKey, projectUrl, renderForm, renderLink, root, updateForm, updateListener, userHtml;
    AJS.toInit(function() {
      if (root().length) {
        return initPage();
      }
    ...
    initUserInput = function() {
      ...
      return element.select2({
          ...
          results: function(data, page, query) {
            ...
            for (i = 0, len = data.length; i < len; i++) {
              ...
              users.push({
                ...
                avatar: (ref = user.avatarUrls) != null ? ref["16x16"] : void 0
              });
            }
            return {
              results: users
        ...
        initSelection: function(element, callback) {
          ...
          return get("/rest/api/2/user?username=" + username, {}, function(response) {
            var ref;
            return callback({
              id: response.name,
              text: response.displayName,
              avatar: (ref = response.avatarUrls) != null ? ref["16x16"] : void 0
            });
          });
        },
    ...
    userHtml = function(user) {
      return "<span class=\"aui-avatar aui-avatar-xsmall\">\n    	<span class=\"aui-avatar-inner\">\n    		<img src=\"" + user.avatar + "\">\n  		</span>\n</span>\n" + user.text;
    };
